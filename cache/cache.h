    ...
    namespace cache {
        namespace internal {
            ...
            */
            ...
            template <typename T>
            std::vector<T> load(const std::string&) {
                console::print(console::print_type::error, "This type is not supported for caching");
                return std::vector<T>();
            }
            template <>
            std::vector<int> load(const std::string& _cache_name) {
                return load_number<int>(_cache_name);
            }
            template <>
            std::vector<double> load(const std::string& _cache_name) {
                return load_number<double>(_cache_name);
            }
            template <>
            std::vector<std::string> load(const std::string& _cache_name) {
                return load_string(_cache_name);
            }
            ...
            */
            ...
            template <typename T>
            void make(const std::vector<T>&, const std::string&) {
                console::print(console::print_type::error, "This type is not supported for caching");
            }
            template <>
            void make(const std::vector<int>& _vector, const std::string& _cache_name) {
                make_number(_vector, _cache_name);
            }
            template <>
            void make(const std::vector<double>& _vector, const std::string& _cache_name) {
                make_number(_vector, _cache_name);
            }
            template <>
            void make(const std::vector<std::string>& _vector, const std::string& _cache_name) {
                make_string(_vector, _cache_name);
            }
        }
